...
<div class="page-wrapper">
  <div class="header">
    <div class="logo">
      <?php if ($logo): ?>
        <?php print l(theme('image', array('path' => $logo, 'alt' => t('Home'), 'title' => t(''))), $front_page, array('attributes' => array('id' => array('logo')), 'html' => TRUE, 'external' => TRUE)) ?>
      <?php endif; ?>
    </div>
  ...
  <div class="middle">
    <div class="middle-content">
      ...
      <?php endif; ?>   
      <div class="middle-content-title with-border">
        <?php if ($nav1_title): ?>
          <h4><?php print $nav1_title; ?></h4>
        <?php endif; ?>
        <?php print render($title_prefix); ?>

        <?php if ($extra_title): ?>
          <h2><?php print $extra_title; ?></h2>
        <?php else : ?>
          <?php if (isset($phys) || !empty($phys)): ?>
            <?php print theme('image', array('path' => $icon)); ?>   
            <h2><?php print $phys; ?></h2>
          <?php else : ?>
            <?php if ($title): ?>
        ...
        <?php if (empty($back_link) || !isset($back_link)) : ?>
          <?php print theme("links", $home_links); ?>
        <?php else : ?>
          <?php print theme("links", $home_back_links); ?>
        <?php endif; ?>
      </div>
      <?php print $messages; ?>
      ...
      <?php if (!array_key_exists("identifier", $_REQUEST) || ($_REQUEST["identifier"]== NULL) ) { ?>
