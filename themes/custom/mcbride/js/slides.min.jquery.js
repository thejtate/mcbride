...
//            debugger;
            ...
            if (option.generatePagination) {
                ...
                elem.append('<div class="' + option.paginationClass + '-wrapper"><ul class=' + option.paginationClass + '></ul></div>');
                control.children().each(function() {
                    $('.' + option.paginationClass, elem).append('<li><a href="#' + number + '">' + (number + 1) + '</a></li>');
                    number++;
                });
//                 debugger;
                $('.'  + option.paginationClass, elem).css('left', (elem.width() - $('.' + option.paginationClass, elem).width())/2 + 'px');
